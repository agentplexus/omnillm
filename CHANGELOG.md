...
- `Tool`, `ToolSpec`, `ToolCall`, `ToolFunction` types for tool calling ([`06824f2`](https://github.com/agentplexus/omnillm/commit/06824f2))
- `Tools` and `ToolChoice` fields in `ChatCompletionRequest` ([`06824f2`](https://github.com/agentplexus/omnillm/commit/06824f2))
- `ToolCallID` and `ToolCalls` fields in `Message` ([`06824f2`](https://github.com/agentplexus/omnillm/commit/06824f2))
- Conversion between unified tool format and OpenAI format ([`06824f2`](https://github.com/agentplexus/omnillm/commit/06824f2))

### Documentation

- MkDocs documentation site with Material theme ([`3bc816c`](https://github.com/agentplexus/omnillm/commit/3bc816c))
- Organized release notes in docs/releases/ ([`3bc816c`](https://github.com/agentplexus/omnillm/commit/3bc816c))
...
[unreleased]: https://github.com/agentplexus/omnillm/compare/v0.12.0...HEAD
[v0.12.0]: https://github.com/agentplexus/omnillm/compare/v0.11.0...v0.12.0
