...
```bash
go get github.com/plexusone/omnillm@v0.11.0
go mod tidy
```
...
- [README](https://github.com/plexusone/omnillm/blob/main/README.md) - Full feature documentation
- [CHANGELOG](https://github.com/plexusone/omnillm/blob/main/CHANGELOG.md) - Complete change history
- [ROADMAP](https://github.com/plexusone/omnillm/blob/main/ROADMAP.md) - Future plans
