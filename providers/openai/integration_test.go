...
// TestOpenAIIntegration_ChatCompletion tests actual API calls
func TestOpenAIIntegration_ChatCompletion(t *testing.T) {
...
// TestOpenAIIntegration_Streaming tests actual streaming API calls
...
// TestOpenAIIntegration_ErrorHandling tests API error responses
func TestOpenAIIntegration_ErrorHandling(t *testing.T) {
	apiKey := os.Getenv("OPENAI_API_KEY")
	if apiKey == "" {
		t.Skip("Skipping integration test: OPENAI_API_KEY not set")
	}
